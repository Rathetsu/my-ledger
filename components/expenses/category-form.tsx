...
export function CategoryForm({
  ...
  existing?: { id: string; name: string; icon: string | null }
}) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="inline-flex min-h-11 items-center justify-center rounded-lg bg-neutral-900 px-4 text-white dark:bg-neutral-100 dark:text-neutral-900"
      >
        {existing ? 'Save' : 'Add'}
      </button>
    </form>
